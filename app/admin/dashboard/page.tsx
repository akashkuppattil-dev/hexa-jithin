  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Link href="/admin/categories" className="block bg-white p-6 rounded shadow hover:shadow-lg transition">
          <h2 className="text-xl font-bold">Manage Categories</h2>
          <p className="text-gray-600">Create, update, and delete categories.</p>
        </Link>
        <Link href="/admin/brands" className="block bg-white p-6 rounded shadow hover:shadow-lg transition">
          <h2 className="text-xl font-bold">Manage Brands</h2>
          <p className="text-gray-600">Create, update, and delete brands.</p>
        </Link>
        <Link href="/admin/products" className="block bg-white p-6 rounded shadow hover:shadow-lg transition">
